...
// module
exports.push([module.i, ".crumbs[data-v-224ff1e6]{text-decoration:none}.bread[data-v-224ff1e6]{font-size:16px}.form-box[data-v-224ff1e6]{width:300px;margin-top:50px;margin-left:0;box-shadow:0 0 8px 0 rgba(232,237,250,.9),0 2px 4px 0 rgba(232,237,250,.9);padding:50px 50px 50px 10px}.submit-btn[data-v-224ff1e6]{width:220px;margin-left:80px}.submit-btn button[data-v-224ff1e6]{width:100%}.news-box[data-v-224ff1e6]{padding:28px;width:800px;border:1px solid #e1e1e1;box-shadow:0 0 2px rgba(0,0,0,.1)}.news-title[data-v-224ff1e6]{font-size:22px;color:#287d7c;line-height:50px;font-weight:400;display:block}.borderline[data-v-224ff1e6]{border-bottom:1px dotted #bfbfbf}.artinfo[data-v-224ff1e6]{float:left;padding-bottom:5px;color:#999;margin:0;padding:0;display:block}.author[data-v-224ff1e6]{color:#666}.article p[data-v-224ff1e6]{padding:30px 0 50px;font-size:18px;color:#333;line-height:200%;text-indent:2em}.article[data-v-224ff1e6]{display:inline-block;line-height:26px;padding-bottom:25px}.news-img[data-v-224ff1e6]{text-align:center}.news-comment[data-v-224ff1e6]{margin-top:20px;text-align:center}", ""]);
...
var update = __webpack_require__(186)("588b8fce", content, true);
